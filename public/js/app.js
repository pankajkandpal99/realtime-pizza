...
var updateCart = function updateCart(pizza) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/update-cart", pizza).then(function (res) {
    ...
    (toastr__WEBPACK_IMPORTED_MODULE_0___default().options) = {
      ...
      timeOut: 1000,
      // Disappear after 1 seconds
      // progressBar: true,
      closeButton: true // Show close button
    };

    toastr__WEBPACK_IMPORTED_MODULE_0___default().success("Item added to your cart.");
